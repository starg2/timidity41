...
// Font
        char SystemFont[LF_FULLFACESIZE + 4];
        char PlayerFont[LF_FULLFACESIZE + 4];
        char WrdFont[LF_FULLFACESIZE + 4];
        char DocFont[LF_FULLFACESIZE + 4];
        char ListFont[LF_FULLFACESIZE + 4];
        char TracerFont[LF_FULLFACESIZE + 4];
        int SystemFontSize;
        int PlayerFontSize;
        int WrdFontSize;
        int DocFontSize;
