...
//				 "%x", wParam);
			...
			case 0x68:	// h
				...
				MessageBox(hTracerWnd,
					...
					"  +: キーアップ    -: キーダウン\n"
					"  >: スピードアップ    <: スピードダウン\n"
					"  UP: -1ch スクロール    DOWN: +1ch スクロール\n"
					"  PgUp: ページアップスクロール    PgDn: ページダウンスクロール\n"
					"  HOME: ページアップスクロール    END: ページダウンスクロール\n"
					"プレイヤーコマンド\n"
				...
				MessageBox(hTracerWnd,
					...
					"  +: Key up    -: Key down\n"
					"  >: Speed up    <: Speed down\n"
					"  UP: -1ch scroll    DOWN: +1ch scroll\n"
					"  PgUp: Page up scroll    PgDn: Page down scroll\n"
					"  HOME: Page up scroll    END: Page down scroll\n"
					"Player command.\n"
