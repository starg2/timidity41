...
static INT_PTR APIENTRY CALLBACK ISEditorSCCProc(HWND hwnd, UINT uMess, WPARAM wParam, LPARAM lParam)
{
	int i, tmp;
	WORD clid = 0;
	static WORD focus_clid = 0;
...
static INT_PTR APIENTRY CALLBACK ISEditorMMSProc(HWND hwnd, UINT uMess, WPARAM wParam, LPARAM lParam)
{
	int i, tmp;
	WORD clid = 0;
...
INT_PTR APIENTRY CALLBACK ISEditorWndDialogProc(HWND hwnd, UINT uMess, WPARAM wParam, LPARAM lParam)
{
	int i;
	WORD clid = 0;
	static WORD focus_clid = 0, prv_focus_clid = 0;
