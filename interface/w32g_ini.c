...
///r
	...
	// reverb ex2	
	MyIni_SetFloat32(sec, "Ext_SR_Level", ext_reverb_ex2_level);
	MyIni_SetInt32(sec, "Ext_SR_RS_Mode", ext_reverb_ex2_rsmode);
	MyIni_SetInt32(sec, "Ext_SR_FFT_Mode", ext_reverb_ex2_fftmode);
	// plate reverb
