...
void recompute_voice_lfo(int v)
{
	...
	// LFOampはvol_envを使用しないのでここで (recompute_voice_amp()と	どっちでもいいけど
	// 後の工程  mix.c update_tremolo() -> apply_envelope_to_amp() -> mix_mystery_signal()
	// filter/pitch は recompute_voice_filpter/pitch()
}
