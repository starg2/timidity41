...
libOggFLAC_dll_t *load_libOggFLAC_dll(const char *path)
{
  ...
  if (!dll->OggFLAC__stream_encoder_new) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_delete) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_serial_number) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_verify) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_streamable_subset) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_do_mid_side_stereo) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_loose_mid_side_stereo) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_channels) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_bits_per_sample) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_sample_rate) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_blocksize) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_max_lpc_order) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_qlp_coeff_precision) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_do_qlp_coeff_prec_search) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_do_escape_coding) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_do_exhaustive_model_search) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_min_residual_partition_order) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_max_residual_partition_order) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_rice_parameter_search_dist) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_total_samples_estimate) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_metadata) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_write_callback) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_set_client_data) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_state) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_FLAC_stream_encoder_state) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_verify_decoder_state) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_verify_decoder_error_stats) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_verify) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_streamable_subset) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_do_mid_side_stereo) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_loose_mid_side_stereo) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_channels) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_bits_per_sample) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_sample_rate) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_blocksize) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_max_lpc_order) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_qlp_coeff_precision) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_do_qlp_coeff_prec_search) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_do_escape_coding) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_do_exhaustive_model_search) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_min_residual_partition_order) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_max_residual_partition_order) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_rice_parameter_search_dist) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_get_total_samples_estimate) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_init) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_finish) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_process) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_encoder_process_interleaved) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_new) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_delete) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_read_callback) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_write_callback) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_metadata_callback) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_error_callback) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_client_data) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_serial_number) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_metadata_respond) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_metadata_respond_application) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_metadata_respond_all) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_metadata_ignore) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_metadata_ignore_application) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_set_metadata_ignore_all) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_get_state) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_get_FLAC_stream_decoder_state) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_get_channels) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_get_channel_assignment) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_get_bits_per_sample) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_get_sample_rate) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_get_blocksize) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_init) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_finish) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_flush) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_reset) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_process_single) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_process_until_end_of_metadata) err++;
#endif
  ...
  if (!dll->OggFLAC__stream_decoder_process_until_end_of_stream) err++;
#endif
  ...
  if (!dll->OggFLAC__StreamEncoderStateString) err++;
#endif
  ...
  if (!dll->OggFLAC__StreamDecoderStateString) err++;
#endif
...
int g_load_libOggFLAC_dll(const char *path)
{
	if (g_libOggFLAC_dll) return 0;
	g_libOggFLAC_dll = load_libOggFLAC_dll(path);
	if (!g_libOggFLAC_dll) return -1;
#ifndef IGNORE_libOggFLAC_OggFLAC__StreamEncoderStateString
